...
export const zhCnDictionary: DictionaryShape = {
  ...
  helpers: {
    ...
    schemaDiffTitle: "Schema 变更记录",
    schemaDiffHint: "对比上游 config.schema.json 的发布标签（v0.100.0+）字段差异。",
    schemaDiffEmpty: "该版本无字段级变化。",
    schemaDiffAdded: "新增",
    schemaDiffRemoved: "移除",
    schemaDiffDeprecated: "已废弃",
  },
  options: {
    approvalPolicy: {
      untrusted: "Untrusted",
